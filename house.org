...
| E |   8.550 |      3.080 | 10.080 |   3.490 |    1.135 |    3.835 | 19.405 |      6.920 |    3.155 |    2.950 |     1.915 |  3.955 |   1.385 |    10.615 |       3.830 |             |            9.775 |
...
| S |   1.355 |            |        |         |    4.885 |          |  7.560 |      3.700 |    3.080 |          |           |  2.600 |         |           |             |             |                  |
...
| kitchen           | (0,0)--(0,0)--(0,-J)--(D-E,-J)--(D-E,K-J)--(0,K-J)--cycle                                                                   |
...
| laundry           | (0,0)--(DD,0)--(DD,K)--(0,K)--cycle                                                                                         |
...
| kitchen           | lrcorner garage + (th+E,0)                                           |           1 |        |
...
|  7 | "Big proposed laundry opening" | right    | up      | point 3 of laundry          | .1est            | DD-.2est     |
|  4 | "Living to garage entry"       | right    | up      | point 5 of kitchen          | 0.1est           | B+1.4est      |
...
\startMPcode{decimalfun}
  ...
  %if laurel:
  %   path p;
  %   p = (0,0)--(20ft,0)--(20ft,35ft)--(0,35ft)--cycle;
...
#+begin_src metapost
  ...
  if true:
    ...
    for i=0 upto 76*4:
      if i mod 4 = 0:
        draw ((LB,-J)--(LB,28ft)) shifted (i*ft/4,0) withcolor .5 white;
      else:
        draw ((LB,-J)--(LB,28ft)) shifted (i*ft/4,0) withcolor .9 white;
      fi;
      for j=0 upto 40*4:
        if j mod 4 = 0:
          draw ((LB,-J)--(LB+76ft,-J)) shifted (0,j*ft/4) withcolor .5 white;
        else:
          draw ((LB,-J)--(LB+76ft,-J)) shifted (0,j*ft/4) withcolor .9 white;
        fi;
      endfor;
    endfor;
  fi;
