...
def drawwindow (expr direction, outdirection, start, offset, width, i) =
  ...
  undraw window[i] shifted (outdirection * th/2);
  draw window[i] shifted (outdirection * th/2) withcolor blue withtransparency ("normal", .5);
enddef;
""")
windows = windows[1:]
