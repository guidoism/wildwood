...
#+name: Windows
| 0 | "Window over sink"           | right | down | point 2 of kitchen    | L  | M-N   |   |   |
...
window[5] := doorup right (point 1 of southbed, FI, FK);
window[6] := doorleft up (point 2 of southbed, FD, FE);
window[7] := doorleft up (point 4 of smallbed, EH, EP-EH-EQ);
window[8] := doordown left (point 5 of smallbed, EJ, EL-EJ);
window[9] := doorleft down (point 1 of master, JF, JD-JG-JF);
window[10] := doorup right (point 1 of master, JC, JA-JB-JC);
window[11] := doorup right (point 1 of masterbathtoilet, GR, GS-GR);
window[12] := doorup right (point 3 of hallbath, HF, HH);
window[13] := doorright up (point 3 of garage, LL, LI);
window[14] := doorleft up (point 2 of garage, LK, LJ);
window[15] := doorright down (point 0 of blueroom, ID, IB-IC-ID);
