...
| C |  18.530 |     10.580 | 19.190 |   8.725 |    3.550 |    5.395 |  4.960 |      2.415 |    9.325 |    1.535 |     2.415 |  4.040 | 16.035  | 10.650    |      11.615 |             |
...
| I |   0.330 |      5.690 | 15.470 |   4.890 |   11.955 |    4.370 |  1.040 |      4.465 |    2.260 |    5.895 |           |  3.380 |  2.590  |           |         4.1 |             |
| J |  12.525 |      4.435 |  3.365 |   3.025 |    3.740 |    4.115 |  2.340 |      0.790 |    2.010 |    7.025 |     0.555 |  3.380 | 11.055  |           |       2.595 |             |
| K |  15.975 |      6.040 |  3.985 |   2.840 |    1.800 |    3.405 |  0.825 |      1.245 |    2.530 |    0.560 |           |  3.640 |  3.540  |           |       8.745 |       5.040 |
| L |   2.155 |      4.385 |  6.900 |   2.250 |    6.655 |    2.450 | 15.975 |      5.440 |          |    0.565 |     0.590 |  3.780 |  2.935  |           |       1.895 |             |
| M |   7.950 |      1.475 |  1.220 |   2.615 |    2.315 |    0.610 | 12.690 |      2.000 |          |    2.485 |     9.420 | 12.180 |  8.205  |           |       2.110 |             |
...
| garageattic       | (0,0)--(OB,0)--(OB,OK)--(OB+OI,OK)--(OB+OI,OK+OJ)--(OB,OK+OK)--(OB,OA)--(0,OA)--cycle                                       |
...
| recroom           | (xpart point 1 of master - MA, ypart point 0 of smallbedcloset - MC) |
...
""")
upstairs = {'recroom'}
print('\n'.join((f'drawwall({s}, th);' for s in paths if s not in upstairs)))
print()
print('pickup pencircle scaled 1bp;')
print('\n'.join((f'draw {s};' for s in paths if s not in upstairs)))
print('\n'.join((f'draw {s} withcolor red;' for s in paths if s in upstairs)))
#+end_src
