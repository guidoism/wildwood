...
GA :=  3.095 ft;          HA :=  ft;          IA := 15.985 ft;
GB :=  4/12 EstFt;        HB :=  ft;          IB := 10.990 ft;
GC :=  2.415 ft;          HC :=  ft;          IC :=  1.535 ft;
GD :=  4/12 EstFt;        HD :=  ft;          ID :=  1.520 ft;
GE :=  6.920 ft;          HE :=  ft;          IE :=  2.950 ft;
GF :=  2.420 ft;          HF :=  ft;          IF :=  0.990 ft;
GG :=  2.075 ft;          HG :=  ft;          IG :=  0.565 ft;
GH :=  9.005 ft;          HH :=  ft;          IH :=  7.455 ft;
GI :=  4.465 ft;          HI :=  ft;          II :=  5.895 ft;
GJ :=  0.790 ft;          HJ :=  ft;          IJ :=  7.025 ft;
GK :=  1.245 ft;          HK :=  ft;          IK :=  0.560 ft;
GL :=  5.440 ft;          HL :=  ft;          IL :=  0.565 ft;
GM :=  2.000 ft;          HM :=  ft;          IM :=  2.485 ft;
GN := 12.235 ft;          HN :=  ft;          IN := 13.260 ft;
GO :=  3.020 ft;          HO :=  ft;          
GP :=  4.880 ft;          HP :=  ft;          
GQ :=  6.830 ft;          HQ :=  ft;          
GR :=  0.825 ft;          HR :=  ft;          
