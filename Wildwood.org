...
%hallbath := (0,0)--(HB,0)--(HB,-HE)--(HA,-HE)--(HA,HF-HE)--(HA-HC,HF-HE)--(HA-HC,HS)--(0,HS)--cycle;
%hallbath := (0,0)--(HA,0)--(HA,HS+HI)--(0,HS+HI)--cycle;
%hallbath := (0,0)--(HB,0)--(HB,-HE)--(HA,-HE)--(HA,HT)--cycle;
%hallbath := (0,0)--(HB,0)--(HB,-HE)--(HA,-HE)--(HA,3ft)--(0,3ft)--cycle;
...
%hallbathcloset := hallbathcloset shifted (point 3 of masterbathcloset + (0,th));
