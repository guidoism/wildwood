...
if true:
  label.rt(btex Kitchen etex, .5[point 1 of kitchen, point 0 of window[1]]);
fi;
...
if false:
  pickup pencircle scaled .01bp;
  for i=0 upto 25:
    draw ((LB,-J)--(LB,AD+K-J+th)) shifted (i*ft,0) withcolor .5 white;
    for j=0 upto 31:
      draw ((LB,-J)--(LB+25ft,-J)) shifted (0,j*ft) withcolor .5 white;
    endfor;
  endfor;
fi;
