...
% L A U N D R Y --- S M A L L B E D
DA := 2.620 ft;     EA := 12.000 ft;
DB := 5.375 ft;     EB :=  7.370 ft;
DC := 8.725 ft;     EC :=  3.550 ft;
DD := 8.070 ft;     ED := 14.900 ft;
DE := 3.490 ft;     EE :=  1.135 ft;
DF := 2.685 ft;     EF :=  4.630 ft;
DG := 2.915 ft;     EG :=  2.420 ft;
DH := 3.025 ft;     EH :=  9.935EstFt;
DI := 4.890 ft;     EI := 12.250EstFt;
DJ := 3.025 ft;     EJ :=  3.740 ft;
DK := 2.840 ft;     EK :=  1.800 ft;
DL := 2.250 ft;     EL :=  6.655 ft;
