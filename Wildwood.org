...
J := 12.525 ft;     AJ :=  4.435 ft;     %BJ :=  ft;
K := 15.975 ft;     AK :=  6.040 ft;     %BK :=  ft;
L :=  2.155 ft;     AL :=  4.385 ft;     %BL :=  ft;
M :=  7.950 ft;     AM :=  1.475 ft;     %BM :=  ft;
N := 10.920 ft;     AN := 38.520 ft;     %BN :=  ft;
O := 15.855 ft;     
P := 17.110 ft;     
Q := 22.905 ft;     
R := 24.460 ft;     
...
% Kitchen floor
draw (point 2 of kitchen shifted (9.990ft,0))--(point 2 of kitchen shifted (9.990ft,K)) withpen pencircle scaled .1bp dashed withdots;
