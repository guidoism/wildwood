...
door[5] := doorleft  (point 4 of kitchen, 6, 36);     undraw door[5]; % Family to front entry
...
drawdimension((point 5 of kitchen)--(point 0 of door[4]), (0,0)); % TODO: how to get lower part
