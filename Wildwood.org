...
KG := 1.595 ft;           LG := 13.085 ft;    MG :=  ft;
                          LH :=  ft;          MH :=  ft;
                          LI :=  3.380 ft;    MI :=  ft;
KJ := 0.555 ft;           LJ :=  3.380 ft;    MJ :=  ft;
                          LK :=  3.640 ft;    MK :=  ft;
KL := 0.590 ft;           LL :=  3.780 ft;    ML :=  ft;
KM := 9.420 ft;           LM := 12.180 ft;    MM :=  ft;
                          LN :=  0.570 ft;    MN :=  ft;
...
if true:
  ...
  window[16] := doorup(point 1 of recroom, MQ, MO);
  drawwindow(window[16], right);
