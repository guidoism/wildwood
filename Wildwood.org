...
%laundry := (0,0)--(0,-DN)--(-DF,-DN)--(-DF,-DN-DE)--(-DF+DG,-DN-DE)--(DB-DH,-DC)--(DB,-DC)--(DB,0)--cycle;
%laundrybath := (0,0)--(DD,0)--(DD,DJ)--(DD-DH,DJ)--(DG,DI)--(0,DI)--cycle;
laundry := (0,0)--(DD,0)--(DD,J)--(0,J)--cycle;

% Just the wall separtating the laundry from the bath
laundrybath := (0,DI)--(DG,DI)--(DD-DH,DJ)--(DD,DJ);
...
%laundry     := laundry shifted (point 1 of kitchen + (-DB-6,-6));
%laundrybath := laundrybath shifted (lrcorner garage + (6,-DN-DE-DI-6-6-6-6-6));
