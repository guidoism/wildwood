...
t = wall_depth / 2;
draw (0-t,0-t)--(garage_width+t,0-t)--(garage_width+t,garage_depth+t)--(0-t,garage_depth+t)--cycle withcolor .8 white;

undraw (garage_width+t,0.5ft)--(garage_width+t,0.5ft+3ft);
undraw (0-t,5ft)             --(0-t,5ft+8ft);              % 5ft from bottom, 8ft wide
undraw (0-t,garage_width-2ft)--(0-t,garage_width-2ft-8ft); % 2ft from the top, 8ft wide

% L I V I N G   R O O M
path p;
p = (0,0)--(living_width,0)--(living_width,living_depth)--(0,living_depth)--cycle;

pickup pensquare scaled (2wall_depth);
draw p shifted (garage_width+wall_depth, mud_hall_depth+wall_depth) withcolor .8 white;
unfill p shifted (garage_width+wall_depth, mud_hall_depth+wall_depth);
pickup pensquare scaled 1bp;
draw p shifted (garage_width+wall_depth, mud_hall_depth+wall_depth);
#+end_src
